...
- **OASIS: Outlier-Aware LUT-Based GEMM with Dual-Side Quantization for LLM Inference Acceleration** *Duke University* (ISCA 2026) [[paper]](https://arxiv.org/abs/2507.23035)

- **Omni-LUT: Energy-Efficient LUT-based Accelerator with Hardware-Aware KV Cache Quantization** *National Yang Ming Chiao Tung University* (ISCA 2026) [[paper]]()

- **SingularBit: Exploiting Synergy of SVD and Low-Bit Quantization for Weight and KV Compression in LLM Inference** *KAIST* (ISCA 2026) [[paper]]()

- **EVA: Accelerating LLM Decoding via an Efficient Vector Quantization Architecture** *Duke University* (ISCA 2026) [[paper]](https://arxiv.org/abs/2605.24144)

- **AQuant: Repurposing CODEC for VLM Acceleration via Adaptive Quantization** *SJTU / KAUST* (ISCA 2026) [[paper]]()

- **MXFFP: Microscaling Flexible Floating Point Format for Large-Scale AI Model Acceleration** *Yonsei University / Meta / USC* (ISCA 2026) [[paper]]()

- **UniCore: A Bit-Width Scalable GEMM Unit for Unified LLM Inference** *HKUST(GZ)* (ISCA 2026) [[paper]]()

- **XtraMAC: An Efficient MAC Architecture for Mixed-Precision LLM Inference on FPGA** *NUS* (ISCA 2026) [[paper]](https://arxiv.org/abs/2605.06052)


- **MX+: Pushing the Limits of Microscaling Formats for Efficient Large Language Model Serving** *Seoul National University* (MICRO 2025) [[paper]](https://arxiv.org/abs/2510.14557)

- **AxCore: A Quantization-Aware Approximate GEMM Unit for LLM Inference** *HKUST(GZ)* (MICRO 2025) [[paper]](https://soldierchen.github.io/assets/pdf/axcore-micro25.pdf)

- **Amove: Accelerating LLMs through Mitigating Outliers and Salient Points via Fine-Grained Grouped Vectorized Data Type** *Beihang University / Tsinghua University* (MICRO 2025) [[paper]](https://dl.acm.org/doi/pdf/10.1145/3725843.3756113)

- **Efficient Precision-Scalable Hardware for Microscaling (MX) Processing in Robotics Learning** *KU Leuven* (ISLPED 2025) [[paper]](https://arxiv.org/abs/2505.22404)

- **BBAL: A Bidirectional Block Floating Point-Based Quantisation Accelerator for Large Language Models** *Southeast University / Houmo AI / Nanjing University / Jilin Normal University* (DAC 2025) [[paper]](https://arxiv.org/abs/2504.15721)

- **Oaken: Fast and Efficient LLM Serving with Online-Offline Hybrid KV Cache Quantization** *KAIST* (ISCA 2025) [[paper]](https://arxiv.org/abs/2503.18599)

- **LUT Tensor Core: Lookup Table Enables Efficient Low-Bit LLM Inference Acceleration** *Microsoft Research* (ISCA 2025) [[paper]](https://arxiv.org/abs/2408.06003)

- **Avant-Garde: Empowering GPUs with Scaled Numeric Formats** *Korea University / EPFL / Yonsei University* (ISCA 2025) [[paper]](https://dl.acm.org/doi/pdf/10.1145/3695053.3731100)

- **HiPACK: Efficient Sub-8-Bit Direct Convolution with SIMD and Bitwise Management** *National University of Singapore / Tiangong University* (MICRO 2025) [[paper]](https://dl.acm.org/doi/pdf/10.1145/3725843.3756124)

- **MCBP: A Memory-Compute Efficient LLM Inference Accelerator Leveraging Bit-Slice-enabled Sparsity and Repetitiveness** *Tsinghua University / Shanghai Jiao Tong University* (MICRO 2025) [[paper]](https://arxiv.org/abs/2509.10372)

- **MHE-TPE: Multi-Operand High-Radix Encoder for Mixed-Precision Fixed-Point Tensor Processing Engines** *University of Science and Technology of China / University of Washington / China University of Mining and Technology* (MICRO 2025) [[paper]](https://dl.acm.org/doi/pdf/10.1145/3725843.3756101)